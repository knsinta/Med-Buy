...
public class OrderHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String SQL_TABLE = "CREATE TABLE " + OrderContract.OrderEntry.TABLE_NAME + " ("
                ...
                +  OrderContract.OrderEntry.COLUMN_NAMA + " TEXT NOT NULL, "
                +  OrderContract.OrderEntry.COLUMN_JUMLAH + " TEXT NOT NULL, "
                +  OrderContract.OrderEntry.COLUMN_HARGA + " TEXT NOT NULL); ";
